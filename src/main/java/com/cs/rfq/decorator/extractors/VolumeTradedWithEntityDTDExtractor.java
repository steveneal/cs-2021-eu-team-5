...
public class VolumeTradedWithEntityDTDExtractor implements RfqMetadataExtractor{

    private String since;

    public VolumeTradedWithEntityDTDExtractor() {
    ...
    public Map<RfqMetadataFieldNames, Object> extractMetaData(Rfq rfq, SparkSession session, Dataset<Row> trades) {
        ...
        results.put(RfqMetadataFieldNames.volumeTradedDayToDate, volume);
        return results;
    }
